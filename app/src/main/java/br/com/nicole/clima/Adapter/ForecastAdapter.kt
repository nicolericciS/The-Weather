...
import br.com.nicole.clima.databinding.ForecastViewholderBinding
...
class ForecastAdapter : RecyclerView.Adapter<ForecastAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ForecastAdapter.ViewHolder {
        binding = ForecastViewholderBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder()
    }
    ...
    override fun onBindViewHolder(holder: ForecastAdapter.ViewHolder, position: Int) {
        ...
        binding.tempTv.text = differ.currentList[position].main?.temp?.let {
            Math.round(it)
        }.toString() + "º"
